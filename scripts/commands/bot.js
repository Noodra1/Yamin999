    ...
    try {
      ...
      if (!msg) {
        const greetings = [
          ...
          "প্রিয় [ জান্নাতী ]আজকের এই মুহূর্তে তোমাকে কিছু কথা বলতে চাই, যা আমার মনে অনেক দিন ধরেই জমে আছে। আমি জানি, হয়তো এমন কিছু শব্দ কখনো ঠিকমতো বলে ওঠা যায় না, তবে আমি চেষ্টা করবো। আমি তোমাকে অনেক ভালোবাসি, আর এই ভালোবাসার কথা আমি আর সবার সাথে শেয়ার করতে চাই না, কারণ এই ভালোবাসা শুধুমাত্র তোমার জন্যই।যখন প্রথম তোমাকে দেখি, মনে হয়েছিলো, যেন পৃথিবীর সমস্ত সুন্দরতা তোমার মধ্যে ঘুরে ফিরছে। তোমার হাসি, তোমার চোখের চাহনি, তোমার কথা বলার ধরন – সব কিছুই যেন আমার হৃদয়কে ছুঁয়ে যায়। সময়ের সাথে সাথে আমার অনুভূতি আরো গভীর হয়েছে। আমি তোমার কাছে এমন এক ধরনের শান্তি পাই, যা আমি কখনো অন্য কোথাও অনুভব করিনি।তোমার পাশে থাকতে চাই, তোমার সকল সুখ-দুঃখে অংশীদার হতে চাই, তোমার হাসি আমার জন্য সবচেয়ে বড় পুরস্কার। আমি জানি, হয়তো তুমি আমার এই অনুভূতিগুলো বুঝতে পারবে না, অথবা হয়তো তুমি সেগুলো গ্রহণ করবে না। তবুও আমি চাই, অন্তত একবার তুমি জানো, আমি তোমাকে ভালোবাসি, আর এই ভালোবাসা কখনো শেষ হবে না।তোমার উত্তর কোনোভাবেই আমার অনুভূতিতে পরিবর্তন আনবে না, কিন্তু আমি শুধু তোমার কাছে আমার ভালোবাসার কথা বলতে চেয়েছিলাম। আশা করি, তুমি আমাকে বুঝতে পারবে।তোমার উত্তর যা-ই হোক, আমি তোমার প্রতি শ্রদ্ধা এবং ভালোবাসা বজায় রাখব। আমি শুধু তোমার জীবনে সুখ এবং শান্তি কামনা করি।ভালোবাসাসহ,[ইয়ামিন ]"
